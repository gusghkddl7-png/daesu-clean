      ...
      <div className="border-y">
        <div className="overflow-auto">
          <table className="min-w-[1200px] w-full text-sm">
            ...
            <tbody>
              {rows.map(r => (
                <tr key={r.id} onClick={()=>router.push(`/listings/new?edit=1&id=${encodeURIComponent(r.id)}`)} className={"border-t cursor-pointer hover:opacity-90 " + (r.completed ? "bg-black text-white/40" : (r.vacant ? "bg-pink-50" : ""))}>
