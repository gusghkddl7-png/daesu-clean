...
<div className="mb-3 flex items-center justify-end gap-2">
  <input name="code" readOnly data-locked="1" placeholder="코드번호" className="border rounded px-2 h-9 text-sm w-48" />
  <button type="button" className="border px-2 py-1 rounded text-xs" onClick={()=>{
