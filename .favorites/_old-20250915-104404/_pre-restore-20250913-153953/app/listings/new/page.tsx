...
export default function NewListingPage() {
  ...
  <div className="sticky bottom-0 z-10">
    <div className="bg-white/90 backdrop-blur border rounded-xl px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex gap-2">
        <button type="button" className="border px-3 py-1.5 rounded" onClick={()=>history.back()}>취소</button>
        <button type="submit" className="border px-3 py-1.5 rounded bg-blue-600 text-white">등록</button>
      </div>
    </div>
  </div>
