  ...
  return (
    <main className="w-full mx-auto max-w-[1400px] md:max-w-[1500px] px-4 md:px-6 py-6">
      ...
      <form onSubmit={onSubmit} className="space-y-5">
        {/* 기본 / 거래 */}
        <Section title={
  <div className="flex items-center gap-2"><label className="inline-flex items-center gap-2 mr-2">
    ...
    <span className="flex items-center gap-2 ml-2">
      ...
      <span className="text-[11px] text-gray-400">건물유형 선택시 자동입력</span>
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div>
              <L>거래유형 *</L>
              <div className="flex gap-2"><label className="inline-flex items-center gap-2 mr-2">
  <input type="checkbox" name="completed" />
  <span>거래완료</span>
</label>
            ...
            <div className="md:col-span-3">
              <L>건물유형 *</L>
              <div className="flex flex-wrap gap-2"><label className="inline-flex items-center gap-2 mr-2">
  <input type="checkbox" name="completed" />
  <span>거래완료</span>
</label>
                {BT_CATS.map(c => (
