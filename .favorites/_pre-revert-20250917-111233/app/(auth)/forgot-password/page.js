...
export default function FindPw(){
  ...
  function onSubmit(e){
    e.preventDefault();
    const u = loadUsers().find(x=>x.id===id && x.name===name && x.phone===phone);
    setResult(u ? `\uBE44\uBC00\uBC88\uD638\uB294 "${u.password}" \uC785\uB2C8\uB2E4.` : "\uC77C\uCE58\uD558\uB294 \uAC00\uC785 \uC815\uBCF4\uB97C \uCC3E\uC744 \uC218 \uC5C6\uC2B5\uB2C8\uB2E4.");
  }
    ...
    <div className="screen">
      <div className="card">
        ...
        <form className="form" onSubmit={onSubmit}>
          <div className="row"><label>{'\uC544\uC774\uB514'}</label><input value={id} onChange={e=>setId(e.target.value)} required/></div>
