      ...
      <form onSubmit={onSubmit} className="space-y-5">
        ...
        <Section title="주소 / 건물">
          <div className="space-y-4">
            <div className="flex flex-wrap items-end gap-3">
              <div className="flex flex-col">
                ...
                <Text
                  ...
                  onChange={(e)=>set("addressJibeon", (e.target as HTMLInputElement).value)}
              ...
              <div className="flex flex-col">
                <L>입주가능일</L>
                <div className="flex items-center gap-2">
                  <input tabIndex={-1} type="date" className="border rounded px-3 h-10 text-sm w-[180px]"
                         value={f.availableDate} onChange={(e)=>set("availableDate", (e.target as HTMLInputElement).value)} />
                  <label className="inline-flex items-center gap-2 select-none">
                    <input tabIndex={-1} type="checkbox" className="w-4 h-4"
                           checked={f.availableNegotiable} onChange={(e)=>set("availableNegotiable", e.target.checked)} />
              ...
              <div className="pb-0.5">
                ...
                <label className="inline-flex items-center gap-2 select-none h-10">
                  <input tabIndex={-1} type="checkbox" className="w-4 h-4"
                         checked={f.vacant} onChange={(e)=>set("vacant", e.target.checked)} />
            ...
            <div className="flex flex-wrap items-center gap-6">
              <label className="inline-flex items-center gap-2 select-none">
                <input tabIndex={-1} type="checkbox" className="w-4 h-4"
                       checked={f.elevator} onChange={(e)=>set("elevator", e.target.checked)} />
                <span className="text-sm text-gray-700">엘리베이터 있음</span>
              </label>
              <label className="inline-flex items-center gap-2 select-none">
                <input tabIndex={-1} type="checkbox" className="w-4 h-4"
                       checked={f.parking} onChange={(e)=>set("parking", e.target.checked)} />
                <span className="text-sm text-gray-700">주차 가능</span>
              </label>
              <label className="inline-flex items-center gap-2 select-none">
                <input tabIndex={-1} type="checkbox" className="w-4 h-4"
                       checked={f.pets} onChange={(e)=>set("pets", e.target.checked)} />
        ...
        <Section title="면적 / 구조">
          <div className="grid grid-cols-1 md:grid-cols-5 gap-4">
            ...
            <div className="flex items-end">
              <label className="inline-flex items-center gap-2 select-none">
                <input tabIndex={-1} type="checkbox" className="w-4 h-4"
                       checked={f.loft} onChange={(e)=>set("loft", e.target.checked)} />
          ...
          <div className="flex flex-wrap items-center gap-3">
            {[
              ...
              <label key={key} className="inline-flex items-center gap-2">
                <input tabIndex={-1} type="checkbox" className="w-4 h-4"
                       checked={(f as any)[key]} onChange={(e)=>set(key as any, e.target.checked)} />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div>
              ...
              <Text
                ...
                onChange={(e)=>set("landlordName", (e.target as HTMLInputElement).value)}
            ...
            <div>
              ...
              <Text
                ...
                onChange={(e)=>set("landlordPhone", (e.target as HTMLInputElement).value)}
            ...
            <div>
              ...
              <Text
                value={f.tenantName}
                onChange={(e)=>set("tenantName", (e.target as HTMLInputElement).value)}
            ...
            <div>
              ...
              <Text
                value={f.tenantPhone}
                onChange={(e)=>set("tenantPhone", (e.target as HTMLInputElement).value)}
        ...
        <div className="sticky bottom-0 z-10">
          <div className="bg-white/90 backdrop-blur border rounded-xl px-4 py-3 flex items-center justify-between">
            ...
            <div className="flex gap-2">
              <button type="button" tabIndex={-1} className="px-3 h-10 border rounded-lg" onClick={saveDraft}>임시저장</button>
              <button type="button" tabIndex={-1} className="px-3 h-10 border rounded-lg" onClick={clearForm}>초기화</button>
              <button type="button" tabIndex={-1} className="px-3 h-10 border rounded-lg" onClick={()=>router.push("/listings")}>취소</button>
              <button type="submit" tabIndex={-1} disabled={saving} className={"px-4 h-10 rounded-lg text-white " + (hasError ? "bg-gray-300" : "bg-blue-600 hover:opacity-90")}>
                {saving ? "저장중..." : "저장"}
              </button>
            </div>
          </div>
